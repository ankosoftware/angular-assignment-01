...
namespace ANKO.AgEmailSender.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly AgEmailSenderDbContext _context;

        public HostRoleAndUserCreator(AgEmailSenderDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AgEmailSenderAuthorizationProvider())
